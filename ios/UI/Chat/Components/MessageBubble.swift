...
struct MessageBubble: View {
    ...
    var body: some View {
        HStack {
            if isUserMessage { Spacer(minLength: 44) }
            bubbleCard
            if !isUserMessage { Spacer(minLength: 44) }
        }
    }
    ...
    private var bubbleCard: some View {
        VStack(alignment: .leading, spacing: 10) {
            ...
            inlineCitationsSection
            sourcePreviewsSection
    ...
    private var thoughtProcessSection: some View {
        if let thought = message.thoughtProcess?.trimmingCharacters(in: .whitespacesAndNewlines), !thought.isEmpty {
    ...
    @ViewBuilder
    private var sourcePreviewsSection: some View {
    ...
    private var assistantActionsMenu: some View {
        Menu {
    ...
    private func citationChip(title: String, action: @escaping () -> Void) -> some View {
    ...
    private func sourcePreviewCard(_ preview: SourcePreview) -> some View {
